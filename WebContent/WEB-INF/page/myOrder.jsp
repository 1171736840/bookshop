...
<html>
	...
	<body>
		...
		<div class="main">
			...
			<div id="editCommentPageMask" class="mask" onclick="noneMask()">
				<div class="editCommentPage" onclick="stopPropagation(event)">
					<h2>写评价</h2>
					<textarea placeholder="在这里写下你的评价,最少10字,最多120字。" maxlength="120" onchange="this.value=this.value.substring(0, 120)" onkeydown="this.onchange(this)" onkeyup="this.onchange(this)"></textarea>
