...
<html>
	...
	<body>
		...
		<div id="addAddressMask" class="mask" style="display: none;">
			<div class="mask-Address-page">
				...
				<form id="newAddress">
					...
					<div class="mask-Address-page-item">
						<input type="button" onclick="cancelAddAddress()" value="取消" />
					</div>
				</form>
			</div>
		</div>

		<div id="editAddressMask" class="mask" style="display: none;">
			<div class="mask-Address-page">
				...
				<form id="editAddress">
					...
					<div class="mask-Address-page-item">
						<input type="button" onclick="cancelEditAddress()" value="取消" />
					</div>
				</form>
			</div>
		</div>
